...
def audio_topology():
    ...
    for card in cards_raw:
        ...
        # The sink selector is intentionally global after card/profile choice.
        # PipeWire profiles can expose nodes whose card metadata does not match
        # the selected card, so limiting this list would hide valid HDMI outputs.
