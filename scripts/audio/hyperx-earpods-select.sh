...
LOG_FILE="$AUDIO_DIR/hyperx-earpods.log"

COOLDOWN_MILLISECONDS=2000
TARGET_SINK="earpods_ash_96khz"
...
printf '\n[%s] control=earpods-ash-select pid=%s\n' \
...
echo "action=select-earpods-ash"
...
echo "result=earpods-ash-selected"
echo "sink=$TARGET_SINK"
